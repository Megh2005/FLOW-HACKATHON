...
export default function SellNFT() {
    ...
    const { isConnected, signer, setIsConnected,
        userAddress,
        setUserAddress,
        setSigner, } = useContext(WalletContext);
            ...
            <div className="relative z-10 flex justify-center pt-30 items-center h-full">
                {isConnected ? (
                    <div className="w-full mt-20 max-w-2xl p-8 bg-gray-800 bg-opacity-80 rounded-lg shadow-lg backdrop-blur-md">
                        <h2 className="text-2xl font-bold text-center mb-6">List your NFT</h2>
                        <div className="space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium">Transferable</label>
                                <input
                                    type="number"
                            ...
                            <button
                                ...
                                className={"w-full p-3 mt-4 text-white rounded-lg transition duration-300 bg-blue-600 hover:bg-blue-700"}
                            >
                        ...
                        <button onClick={connectWallet} type="button" className="text-gray-900 mt-[30vh] bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 me-2 mb-2">
