...
export default function SignupFormDemo() {
    ...
    return (
        <div className="absolute inset-0 -z-10 h-full w-full items-center px-5 py-24 [background:radial-gradient(125%_125%_at_50%_10%,#000_40%,#63e_100%)]">
            <div
                className="max-w-md w-full mx-auto flex flex-col items-center justify-center h-auto rounded-xl md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black">
                <form className="my-8 w-full" onSubmit={handleSubmit}>
                    ...
                    <LabelInputContainer className="mb-4">
                        ...
                        <Input required id="avatar" type="file" onChange={handleFileChange} />
                    </LabelInputContainer>
                    {avatarPreview && (
                        <div className="mb-4">
